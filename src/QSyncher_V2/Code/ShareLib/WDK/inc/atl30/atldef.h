...
#define _ATL_PACKING 8
    ...
    #define ATLSTDCALL
#else
    #define ATLSTDCALL __stdcall
#endif

#if defined(_ATL_DLL)
        #define ATLAPI extern "C" HRESULT __declspec(dllimport) ATLSTDCALL
        #define ATLAPI_(x) extern "C" __declspec(dllimport) x ATLSTDCALL
        #define ATLINLINE
#elif defined(_ATL_DLL_IMPL)
        #define ATLAPI extern "C" HRESULT ATLSTDCALL
        #define ATLAPI_(x) extern "C" x ATLSTDCALL
        #define ATLINLINE
#else
        #define ATLAPI HRESULT ATLSTDCALL
        #define ATLAPI_(x) x ATLSTDCALL
