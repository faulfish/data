...
// Implementation
        ...
        HRESULT BindFinished() const throw() { return S_OK; }
...
public:
        ...
        // DBCOLUMNINFO** ppColumnInfo argument). This is due to an improvement of the semantics to
        // avoid possible memory leaks. (see CDynamicAccessor::GetColumnInfo for details).
