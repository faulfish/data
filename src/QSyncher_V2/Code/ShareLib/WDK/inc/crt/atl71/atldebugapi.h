...
void __stdcall AtlTraceGetUpdateEventNameA(__out_z_opt CHAR *pszEventName);
_ATL_INSECURE_DEPRECATE("AtlTraceGetUpdateEventNameU is unsafe. Instead use AtlTraceGetUpdateEventNameU_s") 
void __stdcall AtlTraceGetUpdateEventNameU(__out_z_opt WCHAR *pszEventName);

void __stdcall AtlTraceGetUpdateEventNameA_s(__out_ecount_z_opt(cchEventName) CHAR *pszEventName, __in size_t cchEventName);
void __stdcall AtlTraceGetUpdateEventNameU_s(__out_ecount_z_opt(cchEventName) WCHAR *pszEventName, __in size_t cchEventName);
