...
LPWSTR AFXAPI AfxA2WHelper(__out_ecount(nChars) LPWSTR lpw, __in_z_opt LPCSTR lpa, int nChars);
LPSTR AFXAPI AfxW2AHelper(__out_bcount(nChars) LPSTR lpa, __in_z_opt LPCWSTR lpw, int nChars);
