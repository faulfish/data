...
_AFX_INLINE void* PASCAL CObject::operator new(size_t, void* p) throw()
	{ return p; }
#ifndef _DEBUG
...
_AFX_INLINE void PASCAL CObject::operator delete(void* p, void*)
	{ ::operator delete(p); }
#endif
_AFX_INLINE void* PASCAL CObject::operator new(size_t nSize) throw(...)
...
_AFX_INLINE TCHAR CString::GetAt(int nIndex) const
{
	...
	if(( nIndex >= 0 ) && ( nIndex < GetData()->nDataLength ))
