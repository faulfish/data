...
protected:
	...
	BOOL SameAsSelected(__in_z LPCTSTR lpszCompare, BOOL bCase, BOOL bWord);
	...
	afx_msg void OnDevModeChange(__in_z_opt LPTSTR lpDeviceName);
	//}}AFX_MSG
...
public:
	...
	__declspec(noinline) virtual ~CRichEditDoc() { }
#endif
};
