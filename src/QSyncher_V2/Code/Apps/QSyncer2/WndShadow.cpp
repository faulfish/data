...
***************************************************************************
*
*  $Workfile:   WndShadow.cpp  $
*  $Revision:   1.3  $
*  $Date:   Mar 04 2008 22:38:24  $
*
***************************************************************************
*
* File Description
...
* ----------------
*
* $Log:   //BQT/VM67/Prjbase3/QSyncher_V2/Code/Apps/QSyncer2/WndShadow.cpp.-arc  $
   
      Rev 1.3   Mar 04 2008 22:38:24   Alan Tu
   update

Rev 1.2   Dec 13 2007 15:16:52   Eddy Guo
fix vista error!! When showing maximized then restoring the size, the program will hang.

Rev 1.1   Nov 14 2007 09:54:12   Alan Tu
update
*
*
***************************************************************************/
				...
				else
				{
					...
					if(WS_VISIBLE & lParentStyle)	// Parent may be resized even if invisible
					{
						...
						if(!(pThis->m_Status & SS_VISABLE))
						{
							...
							int nShadWndWid = WndRect.right - WndRect.left + pThis->m_nSize * 2;
							int nShadWndHei = WndRect.bottom - WndRect.top + pThis->m_nSize * 2;
							POINT ptDst = {WndRect.left + pThis->m_nxOffset - pThis->m_nSize, WndRect.top + pThis->m_nyOffset - pThis->m_nSize};
							MoveWindow(pThis->m_hWnd, ptDst.x, ptDst.y, nShadWndWid, nShadWndHei, FALSE);
