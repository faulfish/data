...
namespace QSYNC_LIB
{
	...
	public:
		...
		void AddDevice(const DeviceDataPt ptdevData);
		void RemoveDevice(const DeviceDataPt ptdevData);
		...
		TSTRING GetQualcommPort(const USHORT idProduct,const USHORT idVendor,int nIndex);
