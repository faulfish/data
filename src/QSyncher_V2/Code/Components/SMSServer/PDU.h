 ...
 * ----------------
 *
 * $Log:   //BQT/VM67/Prjbase3/QSyncher_V2/Code/Components/SMSServer/PDU.h.-arc  $
 * 
 *    Rev 1.2   Nov 09 2007 12:59:08   Eddy Guo
 * Add Header
 *
 *
 ***************************************************************************/
...
/*! @file PDU.h
    @brief {brief description of PDU.h}

    {detail description of PDU.h}
*/
/********************************************************************
created:	2006/11/22
...
#ifndef __SMSSERVER_PDU_CODEC_H__
#define __SMSSERVER_PDU_CODEC_H__
#pragma once
...
#define COUNTRY_NUMBER "886"				// So here is Taiwan:)
