 ...
 ***************************************************************************
 *
 *  $Workfile:   xSkinButton.cpp  $
 *  $Revision:   1.0  $
 *  $Date:   Mar 27 2007 20:02:56  $ 
 *
 ***************************************************************************
 *
 * File Description
 ...
 * ----------------
 ***************************************************************************/
 /*$Log:   //BQT/VM67/Prjbase3/QSyncher_V2/Code/Components/UIFramework/Porting/xSkinButton.cpp.-arc  $
   
      Rev 1.0   Mar 27 2007 20:02:56   Alan Tu
   Initial revision.
   
      Rev 1.1   Mar 14 2005 00:22:16   Sky Yang
   Redraw normal image if user clicks check-box button and leave without release mouse.
   
      Rev 1.0   Mar 02 2005 18:59:56   Neko Hsieh
   Initial revision.
  */
...
IMPLEMENT_DYNAMIC(CxSkinButton, CButton)
		...
		if ((lpDrawItemStruct->itemState & ODS_SELECTED)||m_Checked){
			...
			if(m_bNormal.m_hObject==NULL)
                ...
                if ((m_tracking)&&(m_bOver.m_hObject!=NULL)){
					...
					if ((lpDrawItemStruct->itemState & ODS_FOCUS)&&(m_bFocus.m_hObject!=NULL)&&(::GetCapture() == m_hWnd)){
