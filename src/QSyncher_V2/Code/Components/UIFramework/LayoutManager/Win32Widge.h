 ...
 * ----------------
 *
 * $Log:   //BQT/VM67/Prjbase3/QSyncher_V2/Code/Components/UIFramework/LayoutManager/Win32Widge.h.-arc  $
 * 
...
enum ProgressBarStyle
{
	...
	protected:
		...
		{			
			...
			{
				SolidBrush GrayBrush(Color(255, 15, 85, 105));
				graphics.DrawString(
					strTemp.c_str(),
					static_cast<int>(strTemp.size()),
					&myFont,
	...
	public:
		...
		static void Show(Win32WindowBase* pThis,HWND hWindow,bool bShow,bool bErase = false)
		{
			if(hWindow)
			{
				::SetWindowPos(hWindow,NULL,0,0,0,0,bShow ? SWP_SHOWWINDOW|SWP_NOSIZE|SWP_NOMOVE : SWP_HIDEWINDOW|SWP_NOSIZE|SWP_NOMOVE);
