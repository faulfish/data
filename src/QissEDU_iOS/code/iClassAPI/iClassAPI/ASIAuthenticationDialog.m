...
+ (void)dismiss
{
	if ([sharedDialog respondsToSelector:@selector(presentingViewController)])
        [[sharedDialog presentingViewController] presentViewController:[sharedDialog presentingViewController] animated:YES completion:nil];
	else
        [[sharedDialog parentViewController] presentViewController:[sharedDialog parentViewController] animated:YES completion:nil];
}
...
- (void)dismiss
{
	if (self == sharedDialog) {
		...
		if ([self respondsToSelector:@selector(presentingViewController)])
			[[self presentingViewController] presentViewController:[self presentingViewController] animated:YES completion:nil];
		else
			[[self parentViewController] presentViewController:[self parentViewController] animated:YES completion:nil];
	}
}
...
- (void)show
{
	...
	[[self presentingController] presentViewController:[self presentingController] animated:YES completion:nil];
}
