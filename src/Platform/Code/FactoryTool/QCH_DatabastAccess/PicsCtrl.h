...
#endif // _MSC_VER > 1000
#include <atlbase.h>
#include "PICSInterface.tlh"
using namespace PICSInterface;
...
public:
	...
	unsigned char Initial_PICSInterfaceDLL(void); //If return 1, it means you havn't Register PICS Interface.
	CPicsCtrl();
