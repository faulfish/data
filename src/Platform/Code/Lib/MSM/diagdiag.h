...
/*===========================================================================
  ...
  $Header:   //BQT/VM67/Prjbase3/QSyncher_V2/PlatformTool/Code/Lib/MSM/diagdiag.h.-arc   1.1   Apr 01 2009 14:19:24   Kevin Tai  $
...
DIAGPKT_DEFINE_RSP_AS_REQ(DIAG_USER_CMD_F)
...
DIAGPKT_REQ_DEFINE(DIAG_PERM_USER_CMD_F)
  diag_guid_type guid;                   /* GUID for verification         */
...
DIAGPKT_DEFINE_RSP_AS_REQ(DIAG_PERM_USER_CMD_F)
