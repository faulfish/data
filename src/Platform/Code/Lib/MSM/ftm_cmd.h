...
$Header:   //BQT/VM67/Prjbase3/QSyncher_V2/PlatformTool/Code/Lib/MSM/ftm_cmd.h.-arc   1.1   Apr 01 2009 14:19:24   Kevin Tai  $ $DateTime: 2003/10/23 18:05:27 $ $Author:   Kevin Tai  $
...
typedef enum
{
  ...
  FTM_TX_DATA_SOURCE_TWOTONE	/* Add by Jack J Huang, 20 May 2005 for MSM 6275*/
...
//    uint32                     generic_32bit_u;
 ...
 //   #ifdef T_MSM6275
 //   ftm_autocal_pkt_type	       ftm_autocal;    /* Autcal parameters                  */
    ftm_frame_matrix_type     ftm_frame_matrix;    /* frame matrix                       */
//	ftm_rsb_params_type		     ftm_rsb_parms;
//    #endif 
...
enum 
{
  ...
  FTM_LOG    = 9,
  FTM_AGPS_C = 10,
  FTM_GSM_EXTENDED_C = 17, //Add for msm6275 polar calibration, Jack J Huang
  FTM_MODE_MAX
}; 
...
typedef PACKED struct
{
  diagpkt_subsys_header_type_Topaz header;
  ftm_rf_factory_parms rf_params;
}  ftm_pkt_type_Topaz;
...
/* Added for 6275, Jack J Huang BQH, 29 Jun 2005 {*/
  ...
  FTM_UNUSED_1,			          /*   246 - Fill these in... Removed some unnecessary API */
...
/* } Jack J Huang BQH */  
  FTM_GSM_TEST_ID_MAX             /*   300  - illegal test ID                                                         */
} ftm_gsm_id_type;
...
// For backwards compatibility
   ...
   ADC_HDET_CELL,                  // RAW reading: ADIE_MUX_5: HDET for Cell mode [value SHALL be 8]
