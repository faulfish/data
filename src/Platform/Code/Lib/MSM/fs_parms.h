...
$Header:   //BQT/VM67/Prjbase3/QSyncher_V2/PlatformTool/Code/Lib/MSM/fs_parms.h.-arc   1.1   Apr 01 2009 14:19:24   Kevin Tai  $ $DateTime: 2003/06/17 13:43:21 $ $Author:   Kevin Tai  $
...
/* Undefine direct access for unit test. */
  ...
  #undef FS_DIR_INIT_DIRECT_ACCESS

  /* Disable the devices that aren't tested by the Unit test. */
  #undef FS_DEV_ENABLE_AMD
  #undef FS_DEV_ENABLE_SHARP
...
/* Maximum file name length (cannot exceed block size) */
  ...
  #define FS_FILENAME_MAX_LENGTH_P  80
#else
...
/* Maximum number of simultaneously "open" NVIM files in the system */
  ...
  #define FS_MAX_NUM_FILES_NVIM_P   30 
...
#ifdef FS_DEV_UNIT_TEST
  #define FS_MAX_NUM_FILES_UTEST_P  40
  #define FS_MAX_OPEN_FILES_UTEST_P 34
#else
...
#define FS_MAX_OPEN_FILES_BASE_P    6
...
/* complete sector).                                                    */
      ...
      #define FS_FILE_SPACE_LIMIT_P 262144
    #else
