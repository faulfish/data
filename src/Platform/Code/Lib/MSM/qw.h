...
$Header:   //BQT/VM67/Prjbase3/QSyncher_V2/PlatformTool/Code/Lib/MSM/qw.h.-arc   1.1   Apr 01 2009 14:19:26   Kevin Tai  $ $DateTime: 2001/04/23 13:42:02 $ $Author:   Kevin Tai  $
...
===========================================================================*/
#define QW_CVT_Q2N(qw) (*( (uint64 *)(qw) ))
...
MACRO QW_ALIGNED - Determine if given qword is aligned in memory.
      
DESCRIPTION
  This macro shifts left 30 to do a cheap "mod 4" check.  If the result 
  is '0', the item is aligned.
  integer type.  INLINE is used to force type checking.

DEPENDENCIES
  None.

RETURN VALUE
  Checks if the qword given is pointing to aligned memory space.

SIDE EFFECTS
  None.

===========================================================================*/
#define QW_ALIGNED(qw) (!(((int) qw) << 30))
