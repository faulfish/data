...
/*===========================================================================
      ...
      $Header:   //BQT/VM67/Prjbase3/QSyncher_V2/PlatformTool/Code/Lib/MSM/diag.h.-arc   1.1   Apr 01 2009 14:19:22   Kevin Tai  $
...
===========================================================================*/
  typedef void (*diag_log_listener) (uint32 seq_num, const void *log, 
...
===========================================================================*/
  typedef void (*diag_cmd_rsp) (const void *rsp, unsigned int length, 
                                void *param);

/*===========================================================================
...
===========================================================================*/
  boolean diag_cmd_req (const void *req, unsigned int length, 
