...
$Header:   //BQT/VM67/Prjbase3/QSyncher_V2/PlatformTool/Code/Lib/MSM/rex.h.-arc   1.1   Apr 01 2009 14:19:26   Kevin Tai  $
...
typedef void (*rex_isr_func_type)( void );
   ...
   ** -------------------------------------------------------------------- */
   ...
   /* Stack size for the task associated with stack watermarking.
   */
   #ifndef REX_SWM_STACK_SIZE
      #define REX_SWM_STACK_SIZE 1024
   #endif
#endif
...
typedef struct {
  ...
  rex_priority_type      orig_pri;   /* For use with prio-inversion
                                      * prevention.
                                      */
} rex_crit_sect_type;
...
#error code not present
   ...
   boolean                     suspended;    /* whether task starts suspended */
...
extern unsigned int rex_nest_depth;
