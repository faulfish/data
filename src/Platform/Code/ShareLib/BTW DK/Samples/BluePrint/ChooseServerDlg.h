...
//
//  Copyright (c) 2002 - 2006, Broadcom Corporation, All Rights Reserved.
//
//////////////////////////////////////////////////////////////////////////////
...
// Operations
	void DoAddDevice(BD_ADDR p_bda, BD_NAME bd_name, DEV_CLASS dev_class);
...
#define MAX_SERVER_DEVICES 20
	...
	BOOL	m_bDiscActive;
	BOOL	DiscoverSvc();
    CPrintClient::ePRINT_PROFILE    m_ProfileToUse;
