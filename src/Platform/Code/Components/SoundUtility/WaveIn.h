...
public:
	...
	void SetCallbackWnd(HWND hCallbackWnd);
	 HWND GetCallbackWnd();
	 int GetAmplitudeLeft();
	 int GetFrequenceLeft();
	 int GetAmplitudeRight();
	 int GetFrequenceRight();
...
protected:
	HWND m_hCallbackWnd;
	int m_nAmplitudeLeft;
	int m_nFrequenceLeft;
	int m_nAmplitudeRight;
	int m_nFrequenceRight;
	int m_nSampleCount;
};
