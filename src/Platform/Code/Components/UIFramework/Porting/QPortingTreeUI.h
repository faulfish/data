...
#define WM_USER_RBUTTONDOWN WM_USER + 1001
	...
	private:
		...
		int MeasureString(CDC* pDC,bool bSelected, bool bFocus,const CRect& rcItem,const CString& strTemp);
	...
	private:
		...
		IConfigure*						m_pCfgDefaultColor;
		Color m_NormalItemColor;
		Color m_SelectedItemColor;
		Color m_SelectedUnfocusColor;

		IConfigure*						m_pCfgDefaultFont;
		bool m_bNormalItemBold;
		bool m_bSelectedItemBold;
		bool m_bSelectedUnfocusItemBold;
	};
