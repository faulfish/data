 ...
 * ----------------
 *
 * $Log:   //BQT/VM67/Prjbase3/QSyncher_V2/PlatformTool/Code/Components/UIFramework/LayoutManager/LayoutManager.h.-arc  $
 * 
 ...
 * 
 *    Rev 1.30   May 13 2008 14:14:48   Jame Tsai
...
{	
#ifdef _DEBUG
	const TSTRING g_strDeafultPath = _T("..\\Debug\\Pictures2\\Layout\\");
#else
	const TSTRING g_strDeafultPath = _T("Pictures2\\Layout\\");
#endif
	...
	{
	public:
		CLayoutManager(CWnd* pThis, INotify* pINotify, const TSTRING& strFileName = strQXML);
