...
//WORD CCRCMachine::CRC16LCalculation(LPSTR szBuffer, WORD wBitLen);
//WORD CCRCMachine::CRC16Calculation(LPSTR szBuffer, WORD wBitLen);
//DWORD CCRCMachine::CRC30Calculation(LPSTR szBuffer, DWORD dwBitLen);
...
WORD CCRCMachine::CRC16Calculation(LPSTR szBuffer, DWORD dwBitLen)
{
	WORD wData, wCRC16;
...
WORD CCRCMachine::CRC16LCalculation(LPSTR szBuffer, DWORD dwBitLen)
{
	WORD wData, wCRC16;
...
DWORD CCRCMachine::CRC30BlockCal(LPSTR szBuffer, DWORD dwBitLen, DWORD dwOption){
