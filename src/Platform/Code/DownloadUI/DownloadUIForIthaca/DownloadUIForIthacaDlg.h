// DownloadUIForIthacaDlg.h : header file
//
#include <afxole.h>
...
namespace QSYNC_LIB
{
	...
	// CDownloadUIForIthacaDlg dialog
	class CDownloadUIForIthacaDlg : public Win32DoubleBufferQDialogWidge, public INotify, public INotify_ANSI
	{
	// Construction
	public:
		CDownloadUIForIthacaDlg(CWnd* pParent = NULL);	// standard constructor
		virtual ~CDownloadUIForIthacaDlg();

	// Dialog Data
		enum { IDD = IDD_DOWNLOADUIFORITHACA_DIALOG };
	...
	private:
        ...
        void BackupBRTForIthaca();
        void RestoreBRTForIthaca();
	};
}
