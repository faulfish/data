...
namespace QSYNC_LIB
{
    ...
    typedef bool (*pFnReadBatteryVoltage)(int nPort, int& nVoltage);
    typedef bool (*pFnPowerOff)(int nPort);

	class CDownloadUIDlg :  public Win32DoubleBufferQDialogWidge, public INotify
	{
	// Construction
	public:
		CDownloadUIDlg(CWnd* pParent = NULL);	// standard constructor
	...
	public:
		...
		bool LogFn(const char* szMsg,int nStep, int nProgress);
	...
	private:
        ...
        //pFnOnlineMode m_pFnOnlineMode;
        //pFnSetOffline m_pFnSetOffline;
        //pFnResetHandset m_pFnResetHandset;
        //pFnFTMMode m_pFnFTMMode;
        //pFnReadQFuse m_pFnReadQFuse;
        //pFnChangeFTM m_pFnChangeFTM;
        //pFnChangeOnline m_pFnChangeOnline;
        //pFnCheckFTM m_pFnCheckFTM;
        //pFnReadBatteryVoltage m_pFnReadBatteryVoltage;
        //pFnPowerOff m_pFnPowerOff;
        //HMODULE m_hDll;
	...
	private:
        ...
        int WarnDownloadMode(bool& bFused, bool& bSignedCode);
        bool CheckQFuseStage(bool bFused);
        void CheckRevocationStage(int &nAmssVersion, int &nOemsblVersion, bool &CheckVersion);
        int CheckBatteryStage();
        void DownloadStage(bool bCheckVersion);
        void FinalReboot();
        ...
        void UpdateStepInformation(WIN32PictureViewerWidge** pStep);
	};
}
