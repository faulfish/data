...
namespace QSYNC_LIB
{
	...
	BEGIN_MESSAGE_MAP(CTotallyQdownloadApp, CWinApp)
	...
	CTotallyQdownloadApp::CTotallyQdownloadApp():m_pSingleInstanceObj(NULL)
	{
		CreateQSyncerLimitSingleInstance();
	}

	void CTotallyQdownloadApp::CreateQSyncerLimitSingleInstance()
	{
	...
	CTotallyQdownloadApp theApp;


	// CDownloadUIApp initialization

	BOOL CTotallyQdownloadApp::InitInstance()
	{		
