...
namespace QSYNC_LIB
{
	...
	BEGIN_MESSAGE_MAP(CDownloadUIForMelosApp, CWinApp)
	...
	CDownloadUIForMelosApp::CDownloadUIForMelosApp():m_pSingleInstanceObj(NULL)
	{
		CreateQSyncerLimitSingleInstance();
	}

	void CDownloadUIForMelosApp::CreateQSyncerLimitSingleInstance()
	{
	...
	CDownloadUIForMelosApp theApp;


	// CDownloadUIApp initialization

	BOOL CDownloadUIForMelosApp::InitInstance()
	{		
