...
#endif
#include "../odmtpa_qisda_Lavernock/InterfaceExport.h"
#include <map>
#include <string>
#include "afxmt.h"
...
class CFileGetter_Lavernock : public CFileGetterFor6245
{
public:
	CFileGetter_Lavernock();
	...
	CBufferPtr m_ptHex;
	CBufferPtr m_ptOemsbl;
	CBufferPtr m_ptOemsblhd;
	CBufferPtr m_ptAmss;
	CBufferPtr m_ptAmsshd;
	CBufferPtr m_ptCEFS;

private:
	int m_nAmssVersion;
	int m_nOemsblVersion;
};
...
class CODM_Export : public IODMExport
{
	...
	public:
		...
		CShareDownload6245Ptr				 m_ptDownloadModule;
...
private:
	...
	bool SetLocName(long nComport, CFileGetterFor6245& FileManager);
	bool CompareVersion(long nComPort, CFileGetterFor6245& FileManager, bool& bDownloadOEMSBL);
...
private:
	...
	CFileGetter_Lavernock m_FileManager;
};
